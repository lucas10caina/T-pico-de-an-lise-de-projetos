...
for(int p=TAM; p>0; p--){
    ...
    // int arr[TAM] = { 12, 11, 13, 5, 6, 7 };
    int arr_size = sizeof(arr) / sizeof(arr[0]);
  
    printf("Given array is \n");
    printArray(vetor_ordenado_traz_pra_frente, arr_size);
  
    clock_t begin = clock();
    mergeSort(vetor_ordenado_traz_pra_frente, 0, arr_size - 1);
    clock_t end = clock();
